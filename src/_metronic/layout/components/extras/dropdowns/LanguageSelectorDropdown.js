...
const languages = [
  {
    lang: "en",
    name: "English",
    i18n: "DASHBOARD.HEADER.FLAG_DROPDOWN.ENGLISH",
    flag: toAbsoluteUrl("/media/svg/flags/226-united-states.svg"),
  },
  {
    lang: "es",
    name: "Spanish",
    i18n: "DASHBOARD.HEADER.FLAG_DROPDOWN.SPANISH",
    ...
    <Dropdown drop="down" alignRight>
      ...
      >
        <OverlayTrigger
          placement="bottom"
          overlay={
            <Tooltip id="language-panel-tooltip"><FormattedMessage id="DASHBOARD.HEADER.FLAG_DROPDOWN.TOOLTIP" /></Tooltip>
          }
        >
            ...
            >
              ...
              >
                ...
                <span className="navi-text">
                  <FormattedMessage id={language.i18n} />
                </span>
              </a>
            </li>
          ))}
