...
export const UIndex = () => {
  ...
  const permisision = auth.getPermission('Materiales', 'Unidades');
    ...
    <>
      ...
      >
        <div className="alert-text p-5">
          <h2 className="mb-5">Búsqueda de unidades</h2>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={4} md={4} lg={4}>
          <div className={`card card-custom card-stretch gutter-b`}>
            {/* Header */}
            <FCEHeader title={'Crear unidad'} subtitle={'Diligenciar el formulario'}></FCEHeader>
            {/* Body */}
                ...
                <Grid item xs={12} sm={12} md={12} lg={12} className="pt-2 pb-2">
                  <FormControl component="fieldset" className="wd-full">
                    ...
                    <Autocomplete
                      ...
                      size={'small'}
                      style={{ width: "100%" }}
                      renderInput={(params) => <TextField {...params} label="Nombre nivel" variant="outlined" style={{ height: "40px" }} />}
                    />
                  </FormControl>
                </Grid>
                <Grid item xs={12} sm={12} md={12} lg={12} className="pt-2 pb-2">
                  <FormControl component="fieldset" className="wd-full">
                    <FormLabel component="legend">Unidad anterior</FormLabel>
                    <TextField label="Nombre" variant="outlined" size="small" className="form-text-field mt-2" disabled />
                  </FormControl>
                </Grid>
                <Grid item xs={12} sm={12} md={12} lg={12} className="pt-2 pb-2">
                  <FormControl component="fieldset" className="wd-full">
                    <FormLabel component="legend">Ultima unidad?</FormLabel>
        ...
        <Grid item xs={12} sm={8} md={8} lg={8}>
          <Table title={'Listado de unidades'} subtitle={'Información básica'} className="card-stretch gutter-b" data={units} current_page={page} total={total} onChildEdit={handleEdit} onChildCreate={null} onChildPaginationClick={handleChangePage}></Table>
        </Grid>
      </Grid>
    </>
  );
