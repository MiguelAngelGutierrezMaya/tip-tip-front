        ...
        <>
          ...
          {layoutProps.light && (<>
            <div className="d-flex align-items-center p-8 rounded-top">
              ...
              <span className="label label-light-success label-lg font-weight-bold label-inline"></span>
            </div>
          ...
          {!layoutProps.light && (
            ...
            >
              <div className="symbol bg-white-o-15 mr-3">
                <span className="symbol-label text-success font-weight-bold font-size-h4">{user.fullname[0]}</span>
              </div>
